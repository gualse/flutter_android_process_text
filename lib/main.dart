import 'package:androidflutterselect/context_menu.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _textActionList() async {
    List<Object?> result;
    try {
      result = await channel.invokeMethod('textActionList');
    } on PlatformException {
      result = [];
    }
    setState(() {
      _contextMenuItems = List.from(result);
    });
  }
